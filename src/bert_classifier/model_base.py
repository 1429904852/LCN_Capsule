...
class BertClassifier(object):
    ...
    def built_model(self):
        ...
        with tf.name_scope("output"):
            ...
            # self.one_hot_labels_1 = tf.one_hot(self.label_ids_1, depth=self.__num_classes_1)
            # self.one_hot_labels_11 = tf.expand_dims(self.one_hot_labels_1, 1)
            # self.one_hot_labels_11 = tf.tile(self.one_hot_labels_11, [1, self.sequence_len, 1])
            # output_layer_2_1 = tf.concat([output_layer, self.one_hot_labels_11], 2)
            # output_layer_2 = tf.reduce_mean(output_layer_2_1, 1)
            ...
            # self.one_hot_labels_2 = tf.one_hot(self.label_ids_2, depth=self.__num_classes_2)
            # self.one_hot_labels_22 = tf.expand_dims(self.one_hot_labels_2, 1)
            # self.one_hot_labels_22 = tf.tile(self.one_hot_labels_22, [1, self.sequence_len, 1])
            # output_layer_3_1 = tf.concat([output_layer, self.one_hot_labels_22], 2)
            # output_layer_3 = tf.reduce_mean(output_layer_3_1, 1)
